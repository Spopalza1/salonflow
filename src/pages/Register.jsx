...
export default function Register() {
  ...
  return (
    <AuthLayout
      icon={UserPlus}
      title={isInvited ? "Set your password" : "Create your account"}
      subtitle={isInvited ? "Complete your invitation to get started" : "Registration is by invitation only"}
      footer={
        <>
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            ...
            <Input
              ...
              readOnly={isInvited}
              className={`pl-10 h-12 ${isInvited ? "bg-muted cursor-not-allowed" : ""}`}
              required
            />
          </div>
        </div>
